...
import classes from './GroupTalkTextFile.module.css';
// import './VideoTextTalk.css'




const GroupTalkTextFile = (props) => {
  ...
  if (inputData && inputData.fileUrls && inputData.fileUrls.length > 0) {
    ...
    let fileImageUrl = SOCKET_GROUP_URL + '/' + inputData.fileUrls[0];
    let sFileImageUrl = SOCKET_GROUP_URL + '/' + inputData.fileUrls[0];
...
export default GroupTalkTextFile;