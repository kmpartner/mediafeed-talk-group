...
exports.getTextTalk = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getUserTextTalks = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.query.userId;
    const textTalks = yield TextTalk.find({ userId: userId });
    if (!textTalks) {
        // const error = new Error('Could not find text talk.');
        // error.statusCode = 404;
        // throw error;
